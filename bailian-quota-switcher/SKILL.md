...
> 完整文档见 [README.md](README.md) | 版本记录见 README §12 | 踩坑见 [README.md §踩坑速查](README.md#9-踩坑速查)（19 条）
...
> 踩坑详情在 [README.md §9](README.md#9-踩坑速查)（19 条），不单独维护 references/ 目录。
```
...
详见 [README.md §9 踩坑速查](README.md#9-踩坑速查)（19 条）。
