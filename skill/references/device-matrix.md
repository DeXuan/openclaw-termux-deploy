...
| MIX 2S | 2026.7.1-2 | 26.4.0 | 3.53.3 | 仓库（撤版前安装） | **0.19.0** (2026-07-27, Note 7 venv tar, 踩坑31-33) | 3.14.6（原生合规） | 飞书 WebSocket, cli_aaedb902, 已配对 |
...
| Note 4X | 2026.7.1-2 | 26.4.0 | 3.53.0 | **手动 deb + apt-mark hold** | **0.19.0** (2026-07-27, Note 7 venv tar, 踩坑31-34) | 3.14.6（从3.13升级） | 飞书 WebSocket, cli_aaedb239, 已配对 |
